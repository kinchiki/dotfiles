...
canonical_file="$agent_dir/$agent_name.md"
codex_file="$agent_dir/codex.toml"

[[ -f "$canonical_file" ]] || die "missing agent file: ${canonical_file#$ROOT/}"
...
ensure_expected_symlink "$agents_link" "../../agent-resources/agents/$agent_name/$agent_name.md"
ensure_expected_symlink "$claude_link" "../../agent-resources/agents/$agent_name/$agent_name.md"
...
echo "symlink ok: .agents/agents/$agent_name.md -> ../../agent-resources/agents/$agent_name/$agent_name.md"
echo "symlink ok: .claude/agents/$agent_name.md -> ../../agent-resources/agents/$agent_name/$agent_name.md"
