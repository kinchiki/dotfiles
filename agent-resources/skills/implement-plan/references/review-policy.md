...
- Reviewers follow `../../ticket-to-plan/references/test-selection-policy.md`; review scripts pass its contents to the reviewer.
...
- Do not report a missing test or request a new test when `test-selection-policy.md` excludes the direct guarantee being checked.
