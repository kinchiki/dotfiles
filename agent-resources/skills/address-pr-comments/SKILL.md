...
| 7 | Update PR description | Keep body aligned with implementation. |
| 8 | Reply and resolve | Reply `対応済み <commit-url>` before resolving. |
| 9 | Report | Include description, pushed commits, and thread status. |
